...
def model_build_long_short_volatility(input_features_size):
...
def model_train_long_short_volatility(save_path, train_current, train_short, train_long, feature_cols, label_diff):

    input_features_size = len(feature_cols)

    # model_build
    model = model_build_long_short_volatility(input_features_size)
