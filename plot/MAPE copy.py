...
data = pd.read_csv('D:/HeatingOptimization/STCDRank/doc/excel/dropout/MAPE.csv')
print(data)
...
data.loc[0, 'MAPE'] = data.loc[0, 'MAPE'] - 3.5
...
y_ticks = [0, 0.5, 1, 1.5, 2.2, 3.0, 3.5]
y_ticks_labels = [0, 0.5, 1, 1.5, '~', 6.5, 7.0]
