...
################
################
def model_build_STCD_LSTM_F_TC_loss_SC(input_features_size, windows_len, SC_loss_weights, TC_loss_weights):
    ...
    ## 拼接连续特征和离散特征
    merged_short = layers.concatenate([continuous_data_short_diff_all_std, embedding_t_0], axis=2)  # 从第2个维度拼接
    merged_long = layers.concatenate([continuous_data_long_diff_all_std, embedding_t_n], axis=2)  # 从第2个维度拼接

    # other station
    merged_short_other = layers.concatenate([continuous_data_short_diff_all_std_other, embedding_t_0_other], axis=2)  # 从第2个维度拼接
    merged_long_other = layers.concatenate([continuous_data_long_diff_all_std_other, embedding_t_n_other], axis=2)  # 从第2个维度拼接
    ...
    #  模型构建
    ## 输入输出
    model = Model(inputs=[temporal_discount_rate, continuous_data_short_diff_all_std, continuous_data_long_diff_all_std, wind_data_t_0, weather_data_t_0, day_data_t_0, hour_data_t_0, havePeople_data_t_0, wind_data_t_n, weather_data_t_n, day_data_t_n, hour_data_t_n, havePeople_data_t_n, temporal_discount_rate_other, continuous_data_short_diff_all_std_other, continuous_data_long_diff_all_std_other, wind_data_t_0_other, weather_data_t_0_other, day_data_t_0_other, hour_data_t_0_other, havePeople_data_t_0_other, wind_data_t_n_other, weather_data_t_n_other, day_data_t_n_other, hour_data_t_n_other, havePeople_data_t_n_other], outputs=[prediction_short, prediction_long_discount, prediction_short_other, prediction_long_discount_other])
    ## compile
...
def model_train_STCD_LSTM_F_TC_loss_SC(save_folder, multi_time_train_t_0_label_enhancement, multi_time_train_t_0_data_enhancement, multi_time_train_t_n_label, multi_time_train_t_n_data, baseline_std_cols, windows_len, temporal_discount_rate, model_train_data_other, multi_time_0_1_n_data_other, SC_loss_weights, TC_loss_weights):

    input_features_size = len(baseline_std_cols)

    # 解压数据
    label_next_data_t_0, label_next_std_data_t_0, label_current_data_t_0 = multi_time_train_t_0_label_enhancement
    continuous_model_data_t_0, continuous_baseline_data_t_0, wind_data_t_0, weather_data_t_0, day_data_t_0, hour_data_t_0, havePeople_data_t_0 = multi_time_train_t_0_data_enhancement
    label_next_data_t_n, label_next_std_data_t_n, label_current_data_t_n = multi_time_train_t_n_label
    continuous_model_data_t_n, continuous_baseline_data_t_n, wind_data_t_n, weather_data_t_n, day_data_t_n, hour_data_t_n, havePeople_data_t_n = multi_time_train_t_n_data

    #  其他站点数据
    multi_time_train_t_0_label_enhancement_other, multi_time_train_t_0_data_enhancement_other, multi_time_train_t_n_label_other, multi_time_train_t_n_data_other, temporal_discount_rate_other = multi_time_0_1_n_data_other
    ...
    # model_build
    model = model_build_STCD_LSTM_F_TC_loss_SC(input_features_size, windows_len, SC_loss_weights, TC_loss_weights)
    ...
    label_long_std_discount = np.multiply(label_next_std_data_t_n, temporal_discount_rate)
    label_long_std_discount_other = np.multiply(label_next_std_data_t_n_other, temporal_discount_rate_other)
    #print('label_long_diff_std_discount', label_long_diff_std_discount)


    # model.fit
    model.fit([temporal_discount_rate, continuous_baseline_data_t_0, continuous_baseline_data_t_n, wind_data_t_0, weather_data_t_0, day_data_t_0, hour_data_t_0, havePeople_data_t_0, wind_data_t_n, weather_data_t_n, day_data_t_n, hour_data_t_n, havePeople_data_t_n, temporal_discount_rate_other, continuous_baseline_data_t_0_other, continuous_baseline_data_t_n_other, wind_data_t_0_other, weather_data_t_0_other, day_data_t_0_other, hour_data_t_0_other, havePeople_data_t_0_other, wind_data_t_n_other, weather_data_t_n_other, day_data_t_n_other, hour_data_t_n_other, havePeople_data_t_n_other],
              [label_next_std_data_t_0, label_long_std_discount, label_next_std_data_t_0_other, label_long_std_discount_other],
