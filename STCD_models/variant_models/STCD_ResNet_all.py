...
################
################
def model_build_STCD_ResNet_all(input_features_size, windows_len, SC_loss_weights, TC_loss_weights):
    ...
    DNN_fusion_network_sub_1 = create_MDL_fusion_layers_sub_1(fusion_feature_size, windows_len)
    ...
    # 上层不共享
    sub_2_input_size = 32
    DNN_fusion_network_sub_2 = create_MDL_fusion_layers_sub_2(sub_2_input_size, windows_len)
    ...
    # other
    DNN_fusion_network_sub_2_other = create_MDL_fusion_layers_sub_2(sub_2_input_size, windows_len)
...
def model_train_STCD_ResNet_all(save_folder, label_short_diff_std, label_long_diff_std, short_data_std, long_data_std, model_std_cols, windows_len, temporal_discount_rate, model_train_data_other, SC_loss_weights, TC_loss_weights):
    ...
    # model_build
    model = model_build_STCD_ResNet_all(input_features_size, windows_len, SC_loss_weights, TC_loss_weights)
