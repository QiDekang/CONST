...
from common.config import embed_size, discrete_feature_num, learning_rate, SC_loss_weights
...
################
################
def model_build_STCD_LSTM_continuous(input_features_size, windows_len, SC_loss_weights, TC_loss_weights):
    ...
    DNN_fusion_network_sub_1 = create_LSTM_fusion_layers_sub_1(input_features_size, windows_len)
    prediction_short_sub_1 = DNN_fusion_network_sub_1(continuous_data_short_diff_all_std)
    prediction_long_sub_1 = DNN_fusion_network_sub_1(continuous_data_long_diff_all_std)

    # other station
    # 仅共享底层DNN_fusion_network_sub_1
    prediction_short_sub_1_other = DNN_fusion_network_sub_1(continuous_data_short_diff_all_std_other)
    prediction_long_sub_1_other = DNN_fusion_network_sub_1(continuous_data_long_diff_all_std_other)
...
def model_train_STCD_LSTM_continuous(save_folder, label_short_diff_std, label_long_diff_std, short_data_std, long_data_std, model_std_cols, windows_len, temporal_discount_rate, model_train_data_other, SC_loss_weights, TC_loss_weights):
    ...
    # model_build
    model = model_build_STCD_LSTM_continuous(input_features_size, windows_len, SC_loss_weights, TC_loss_weights)
