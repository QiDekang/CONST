...
################
################
def model_build_STCD_LSTM_DF(input_features_size, windows_len, SC_loss_weights, TC_loss_weights):
...
def model_train_STCD_LSTM_DF(save_folder, label_short_diff_std, label_long_diff_std, short_data_std, long_data_std, model_std_cols, windows_len, temporal_discount_rate, model_train_data_other, SC_loss_weights, TC_loss_weights):
    ...
    # model_build
    model = model_build_STCD_LSTM_DF(input_features_size, windows_len, SC_loss_weights, TC_loss_weights)
