...
#  孪生网络融合网络
def create_LSTM_fusion_layers(input_features_size, windows_len):

    #  input
    LSTM_input_features = Input(shape=(windows_len, input_features_size), dtype='float')

    #  layers
    hiddenLayer = LSTM(32, input_shape=(windows_len, input_features_size), kernel_regularizer=regularizers.l2(l2_rate))(LSTM_input_features)
