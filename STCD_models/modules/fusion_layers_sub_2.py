...
#  孪生网络融合网络
def create_fusion_layers_sub_2(fusion_feature_size, windows_len):
    ...
    '''
    hiddenLayer_all = Dense(size_one, activation='relu')(input_features)
    hiddenLayer_all = Dropout(rate=dropout_rate)(hiddenLayer_all)
    hiddenLayer_all = Dense(size_two, activation='relu')(hiddenLayer_all)
    hiddenLayer_all = Dropout(rate=dropout_rate)(hiddenLayer_all)
    hiddenLayer_all = Dense(size_three, activation='relu')(hiddenLayer_all)
    hiddenLayer_all = Dropout(rate=dropout_rate)(hiddenLayer_all)
    '''
    hiddenLayer_all = Dense(size_five, activation='relu', kernel_regularizer=regularizers.l2(l2_rate))(input_features)
    #hiddenLayer_all = Dropout(rate=dropout_rate)(hiddenLayer_all)
