...
def model_trustworthiness_all_baselines(save_folder, model_type, predict_model, label_next_ss, label_diff_ss, multi_time_test_label, multi_time_test_t_0_data, test_t_0_data, feature_ss, change_time_type, windows_len):
    ...
    for i in range(0, len(direction_col_name_list)):
        ...
        model_trustworthiness_baselines(direction_col_name, save_folder, model_type, predict_model, label_next_ss, label_diff_ss, multi_time_test_label, multi_time_test_t_0_data, test_t_0_data, feature_ss, change_time_type, windows_len)
    
    return 'sucess'


def model_trustworthiness_baselines(direction_col_name, save_folder, model_type, predict_model, label_next_ss, label_diff_ss, multi_time_test_label, multi_time_test_t_0_data, test_t_0_data, feature_ss, change_time_type, windows_len):
    ...
    # first, 供温不变时预测的室温
    direction_diff = 0.0
    predict_indoor_temp_first, heat_temp_new_first = get_indoor_temp(direction_col_name, direction_diff, save_folder, model_type, predict_model, label_next_ss, label_diff_ss, multi_time_test_label, multi_time_test_t_0_data, test_t_0_data, feature_ss, change_time_type, windows_len)
    # new
    #print('direction')
    for j in np.arange(0, 41):
        #  构造新的特征
        direction_diff = round(0.1 * (j - 20), 1)  # 供温上下调整2度, 步长0.1度
        predict_indoor_temp, heat_temp_new = get_indoor_temp(direction_col_name, direction_diff, save_folder, model_type, predict_model, label_next_ss, label_diff_ss, multi_time_test_label, multi_time_test_t_0_data, test_t_0_data, feature_ss, change_time_type, windows_len)
...
def get_indoor_temp(direction_col_name, direction_diff, save_folder, model_type, predict_model, label_next_ss, label_diff_ss, multi_time_test_label, multi_time_test_t_0_data, test_t_0_data, feature_ss, change_time_type, windows_len):
    ...
    ## 用预测模型预测室温
    indoor_temp_next_predict_diff, indoor_temp_next_predict_truth = model_predict_baselines(save_folder, model_type, predict_model, label_next_ss, label_diff_ss, multi_time_test_label, multi_time_test_t_0_data_new)
