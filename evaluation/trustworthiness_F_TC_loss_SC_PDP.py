...
def trustworthiness_all_F_TC_loss_SC_PDP(save_folder, model_type, predict_model, label_next_ss, label_diff_ss, short_label_test, short_data_std_test, long_data_std_test, test_data, feature_diff_ss, change_time_type, windows_len, multi_time_test_t_0_label, multi_time_test_t_0_data, multi_time_test_t_n_label, multi_time_test_t_n_data, temporal_discount_rate_test, multi_time_0_1_n_data_other_test, feature_ss):
