...
from evaluation.accuracy_STCD_MDL import model_predict_STCD_MDL


def trustworthiness_all_STCD_MDL(save_folder, model_type, predict_model, label_next_ss, label_diff_ss, short_label_test, short_data_std_test, long_data_std_test, test_data, feature_diff_ss, change_time_type, windows_len, multi_time_0_1_n_data, temporal_discount_rate_test, accuracy_data_other, MDL_model_data_need_test, MDL_model_data_need_test_other):
    ...
    for i in range(0, len(direction_col_name_list)):
        ...
        trustworthiness_STCD_MDL(direction_col_name, save_folder, model_type, predict_model, label_next_ss, label_diff_ss, short_label_test, short_data_std_test, long_data_std_test, test_data, feature_diff_ss, change_time_type, windows_len, multi_time_0_1_n_data, temporal_discount_rate_test, accuracy_data_other, MDL_model_data_need_test, MDL_model_data_need_test_other)
    return 'sucess'


def trustworthiness_STCD_MDL(direction_col_name, save_folder, model_type, predict_model, label_next_ss, label_diff_ss, short_label_test, short_data_std_test, long_data_std_test, test_data, feature_diff_ss, change_time_type, windows_len, multi_time_0_1_n_data, temporal_discount_rate_test, accuracy_data_other, MDL_model_data_need_test, MDL_model_data_need_test_other):
    ...
    # first, 供温不变时预测的室温
    direction_diff = 0.0
    predict_indoor_temp_first, heat_temp_new_first = get_indoor_temp(direction_col_name, direction_diff, save_folder, model_type, predict_model, label_next_ss, label_diff_ss, short_label_test, short_data_std_test, long_data_std_test, test_data, feature_diff_ss, change_time_type, windows_len, multi_time_0_1_n_data, temporal_discount_rate_test, accuracy_data_other, MDL_model_data_need_test, MDL_model_data_need_test_other)
    # new
    #print('direction')
...
def get_indoor_temp(direction_col_name, direction_diff, save_folder, model_type, predict_model, label_next_ss, label_diff_ss, short_label_test, short_data_std_test, long_data_std_test, test_data, feature_diff_ss, change_time_type, windows_len, multi_time_0_1_n_data, temporal_discount_rate_test, accuracy_data_other, MDL_model_data_need_test, MDL_model_data_need_test_other):
    ...
    # 预测
    indoor_temp_next_predict_diff, indoor_temp_next_predict_truth = model_predict_STCD_MDL(model_type, predict_model, label_next_ss, label_diff_ss, short_label_test_new, short_data_std_test_new, long_data_std_test_new, temporal_discount_rate_test, accuracy_data_other, MDL_model_data_need_test, MDL_model_data_need_test_other)
