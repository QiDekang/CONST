...
def model_accuracy_DF_TC_loss(save_folder, model_type, predict_model, label_next_ss, label_diff_ss, short_label_test, short_data_std_test, long_data_std_test, temporal_discount_rate_test):
    ...
    indoor_temp_next_predict_diff, indoor_temp_next_predict_truth = model_predict_DF_TC_loss(model_type, predict_model, label_next_ss, label_diff_ss, short_label_test, short_data_std_test, long_data_std_test, temporal_discount_rate_test)
...
def model_predict_DF_TC_loss(model_type, predict_model, label_next_ss, label_diff_ss, short_label_test, short_data_std_test, long_data_std_test, temporal_discount_rate_test):
