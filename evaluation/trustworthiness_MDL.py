...
def model_trustworthiness_all_MDL(save_folder, model_type, predict_model, label_next_ss, label_diff_ss, multi_time_test_label, multi_time_test_t_0_data, test_t_0_data, feature_ss, change_time_type, windows_len, MDL_baseline_data_test, multi_time_test_t_0_label_other, multi_time_test_t_0_data_other, MDL_baseline_data_test_other):
...
def model_trustworthiness_MDL(direction_col_name, save_folder, model_type, predict_model, label_next_ss, label_diff_ss, multi_time_test_label, multi_time_test_t_0_data, test_t_0_data, feature_ss, change_time_type, windows_len, MDL_baseline_data_test, multi_time_test_t_0_label_other, multi_time_test_t_0_data_other, MDL_baseline_data_test_other):
    ...
    # first, 供温不变时预测的室温
    direction_diff = 0.0
    predict_indoor_temp_first, heat_temp_new_first = get_indoor_temp(direction_col_name, direction_diff, save_folder, model_type, predict_model, label_next_ss, label_diff_ss, multi_time_test_label, multi_time_test_t_0_data, test_t_0_data, feature_ss, change_time_type, windows_len, MDL_baseline_data_test, multi_time_test_t_0_label_other, multi_time_test_t_0_data_other, MDL_baseline_data_test_other)
    # new
    #print('direction')
