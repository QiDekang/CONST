...
def trustworthiness_all_DF_TC_loss_SC(save_folder, model_type, predict_model, label_next_ss, label_diff_ss, short_label_test, short_data_std_test, long_data_std_test, test_data, feature_diff_ss, change_time_type, windows_len, multi_time_0_1_n_data, temporal_discount_rate_test, accuracy_data_other):
