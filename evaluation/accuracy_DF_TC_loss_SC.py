...
def model_accuracy_DF_TC_loss_SC(save_folder, model_type, predict_model, label_next_ss, label_diff_ss, short_label_test, short_data_std_test, long_data_std_test, temporal_discount_rate_test, accuracy_data_other):
    ...
    indoor_temp_next_predict_diff, indoor_temp_next_predict_truth = model_predict_DF_TC_loss_SC(model_type, predict_model, label_next_ss, label_diff_ss, short_label_test, short_data_std_test, long_data_std_test, temporal_discount_rate_test, accuracy_data_other)
...
def model_predict_DF_TC_loss_SC(model_type, predict_model, label_next_ss, label_diff_ss, short_label_test, short_data_std_test, long_data_std_test, temporal_discount_rate_test, accuracy_data_other):
    ...
    if model_type == 'STCD_DNN_DF_TC':
    ...
    elif model_type in ('STCD_DNN_DF_TC_loss_SC', 'STCD_LSTM_DF_TC_loss_SC', 'STCD_ResNet_all', 'STCD_LSTM_DF_TC_SC', 'STCD_LSTM_continuous'):
        ...
        predict_diff_std_short = predict_model.predict([temporal_discount_rate_test, continuous_data_short_diff_all_std, continuous_data_long_diff_all_std, wind_data_t_0, weather_data_t_0, day_data_t_0, hour_data_t_0, havePeople_data_t_0, wind_data_t_1, weather_data_t_1, day_data_t_1, hour_data_t_1, havePeople_data_t_1, wind_data_t_n, weather_data_t_n, day_data_t_n, hour_data_t_n, havePeople_data_t_n, temporal_discount_rate_test_other, continuous_data_short_diff_all_std_other, continuous_data_long_diff_all_std_other, wind_data_t_0_other, weather_data_t_0_other, day_data_t_0_other, hour_data_t_0_other, havePeople_data_t_0_other, wind_data_t_1_other, weather_data_t_1_other, day_data_t_1_other, hour_data_t_1_other, havePeople_data_t_1_other, wind_data_t_n_other, weather_data_t_n_other, day_data_t_n_other, hour_data_t_n_other, havePeople_data_t_n_other])
    elif model_type == 'STCD_LSTM_DF_SC':
        predict_diff_std_short, predict_diff_std_short_other = predict_model.predict([temporal_discount_rate_test, continuous_data_short_diff_all_std, continuous_data_long_diff_all_std, wind_data_t_0, weather_data_t_0, day_data_t_0, hour_data_t_0, havePeople_data_t_0, wind_data_t_1, weather_data_t_1, day_data_t_1, hour_data_t_1, havePeople_data_t_1, wind_data_t_n, weather_data_t_n, day_data_t_n, hour_data_t_n, havePeople_data_t_n, temporal_discount_rate_test_other, continuous_data_short_diff_all_std_other, continuous_data_long_diff_all_std_other, wind_data_t_0_other, weather_data_t_0_other, day_data_t_0_other, hour_data_t_0_other, havePeople_data_t_0_other, wind_data_t_1_other, weather_data_t_1_other, day_data_t_1_other, hour_data_t_1_other, havePeople_data_t_1_other, wind_data_t_n_other, weather_data_t_n_other, day_data_t_n_other, hour_data_t_n_other, havePeople_data_t_n_other])
