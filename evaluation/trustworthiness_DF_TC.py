...
from evaluation.accuracy_DF_TC import model_predict_DF_TC
...
def trustworthiness_all_DF_TC(save_folder, model_type, predict_model, label_next_ss, label_diff_ss, short_label_test, short_data_std_test, long_data_std_test, test_data, feature_diff_ss, change_time_type, windows_len, multi_time_0_1_n_data):
    ...
    for i in range(0, len(direction_col_name_list)):
        ...
        trustworthiness_DF_TC(direction_col_name, save_folder, model_type, predict_model, label_next_ss, label_diff_ss, short_label_test, short_data_std_test, long_data_std_test, test_data, feature_diff_ss, change_time_type, windows_len, multi_time_0_1_n_data)
    return 'sucess'


def trustworthiness_DF_TC(direction_col_name, save_folder, model_type, predict_model, label_next_ss, label_diff_ss, short_label_test, short_data_std_test, long_data_std_test, test_data, feature_diff_ss, change_time_type, windows_len, multi_time_0_1_n_data):
    ...
    # first, 供温不变时预测的室温
    direction_diff = 0.0
    predict_indoor_temp_first, heat_temp_new_first = get_indoor_temp(direction_col_name, direction_diff, save_folder, model_type, predict_model, label_next_ss, label_diff_ss, short_label_test, short_data_std_test, long_data_std_test, test_data, feature_diff_ss, change_time_type, windows_len, multi_time_0_1_n_data)
    # new
    #print('direction')
    for j in np.arange(0, 41):
        #  构造新的特征
        direction_diff = round(0.1 * (j - 20), 1)  # 供温上下调整2度, 步长0.1度
        predict_indoor_temp, heat_temp_new = get_indoor_temp(direction_col_name, direction_diff, save_folder, model_type, predict_model, label_next_ss, label_diff_ss, short_label_test, short_data_std_test, long_data_std_test, test_data, feature_diff_ss, change_time_type, windows_len, multi_time_0_1_n_data)
...
def get_indoor_temp(direction_col_name, direction_diff, save_folder, model_type, predict_model, label_next_ss, label_diff_ss, short_label_test, short_data_std_test, long_data_std_test, test_data, feature_diff_ss, change_time_type, windows_len, multi_time_0_1_n_data):
    ...
    # 预测
    indoor_temp_next_predict_diff, indoor_temp_next_predict_truth = model_predict_DF_TC(model_type, predict_model, label_next_ss, label_diff_ss, short_label_test_new, short_data_std_test_new, long_data_std_test_new)
