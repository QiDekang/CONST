...
################
def model_build_DNN_multi_time(input_features_size, windows_len):
...
def model_train_DNN_multi_time(save_folder, multi_time_train_label, multi_time_train_t_0_data, baseline_std_cols, windows_len):
    ...
    # model_build
    model = model_build_DNN_multi_time(input_features_size, windows_len)
