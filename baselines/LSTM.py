...
from keras.layers import Input, Dense, Lambda, Dropout, Embedding, Reshape, Subtract, LSTM
...
from STCD_models.modules.LSTM_fusion_layers_deep import create_LSTM_fusion_layers_deep


################
################
def model_build_LSTM(input_features_size, windows_len):
    ...
    # 融合网络
    #hiddenLayer = LSTM(32, input_shape=(windows_len, input_features_size), return_sequences=True, name='LSTM_1')(input_num)
    #hiddenLayer = LSTM(32, input_shape=(windows_len, input_features_size), name='LSTM_1')(merged_current_features)
    #hiddenLayer = LSTM(32, input_shape=(windows_len, input_features_size), name='LSTM_2')(hiddenLayer)
    #LSTM_output = Dense(1, name='output')(hiddenLayer)
    ...
    LSTM_fusion_layers = create_LSTM_fusion_layers_deep(fusion_feature_size, windows_len)
    LSTM_output = LSTM_fusion_layers(merged_current_features)

    

    #  模型构建
    ## 输入输出
    model = Model(inputs=[input_current, input_current_wind, input_current_weather, input_current_day, input_current_hour, input_current_people], outputs=[LSTM_output])
    ## compile
...
def model_train_LSTM(save_folder, multi_time_train_label, multi_time_train_t_0_data, baseline_std_cols, windows_len):
    ...
    # model_build
    model = model_build_LSTM(input_features_size, windows_len)
