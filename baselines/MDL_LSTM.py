...
from STCD_models.modules.MDL_fusion_layers_sub_1 import create_MDL_fusion_layers_sub_1
...
def model_train_MDL_LSTM(save_folder, multi_time_train_label, multi_time_train_t_0_data, baseline_std_cols, windows_len, MDL_baseline_data, multi_time_train_t_0_label_other, multi_time_train_t_0_data_other, MDL_baseline_data_other):
